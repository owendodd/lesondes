...
import { siteTitleClass } from '@/lib/siteSpacing'
import type { SiteConfig } from '@/lib/types'

export default async function Site2026Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <LangProvider>
      <div className="min-h-screen flex flex-col">
        ...
        <header className="flex flex-col gap-8 max-[740px]:gap-6 px-10 max-[740px]:px-4 pt-4">
          <SiteNav />
