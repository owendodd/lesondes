...
export const IG1A_SLIDES: SlideDef[] = [
  {
    id: "p3-header",
    direction: "column",
    lines: [
      { id: "p3-title",   text: "LES ONDES",   charDelay: 60, typeOutCharDelay: 40, spaceExtra: 20, pauseAfter: 0, startDelay: 80 },
      { id: "p3-cerbere", text: "Cerbère",      charDelay: 60, typeOutCharDelay: 40, pauseAfter: 0, startDelay: 200 },
      { id: "p3-dates",   text: "May 29 30 31", charDelay: 25, typeOutCharDelay: 40, pauseAfter: 0, startDelay: 400 },
    ],
    nextOverlap: 400,
    typeOutDelay: 800,
  },
...
// ── Props ──────────────────────────────────────────────────────────────────────
export interface Ig1aProps {
  loops?: number;
}

// ── Component ──────────────────────────────────────────────────────────────────
export function Ig1a({ loops = 1 }: Ig1aProps) {
  ...
  const timeline = React.useMemo(
    () => computeTimeline(loops, IG1A_SLIDES),
    [loops]
  );
