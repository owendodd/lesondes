...
import { FINAL_C_SLIDES } from "./final-slides";
...
export interface IgFinalCProps {
  loops?: number;
}

export function IgFinalC({ loops = 1 }: IgFinalCProps) {
  ...
  const timeline = React.useMemo(() => computeTimeline(loops, FINAL_C_SLIDES), [loops]);
