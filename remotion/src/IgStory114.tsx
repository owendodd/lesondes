...
export interface IgStory114Props {
  durationSec?: number;
}

export function IgStory114({ durationSec: _d = 10 }: IgStory114Props) {
  ...
  return (
    <div style={outerStyle}>
      <OffthreadVideo src={staticFile("video/remotion/background1.mov")} style={bgStyle} muted playbackRate={0.8} />
      <div style={centerStack}>
        <Strip><p style={title}>Getting there<br />from Paris</p></Strip>
        <Strip><p style={body}>Daily trains from Gare de Lyon<br />to Cerbère (1 change, ~6.5 hours)</p></Strip>
        <Strip>
          <p style={body}>
            Daily trains from Gare de Lyon<br />to Perpignan (direct, ~5 hours)<br />
            <span style={it}>45min drive/taxi</span>
          </p>
        </Strip>
        <Strip>
          <p style={body}>
            Sleeper trains from Gare de Lyon<br />to Cerbère (direct, ~12 hours)<br />
            <span style={it}>Friday / Sunday nights only</span>
          </p>
        </Strip>
        <Strip>
          <p style={body}>
            Flight to Perpignan<br />(1.5 hours)<br />
            <span style={it}>1 hour drive/taxi</span>
          </p>
        </Strip>
        <Strip><p style={body}>Drive  (~9 hours)</p></Strip>
      </div>
    </div>
  );
}
