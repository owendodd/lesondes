...
export const IG3A_SLIDES: SlideDef[] = [
  {
    id: "3a-info",
    direction: "column",
    lines: [
...
// ── Props ──────────────────────────────────────────────────────────────────────
export interface Ig3aProps {
  loops?: number;
}

// ── Component ──────────────────────────────────────────────────────────────────
export function Ig3a({ loops = 1 }: Ig3aProps) {
  ...
  const timeline = React.useMemo(
    () => computeTimeline(loops, IG3A_SLIDES),
    [loops]
  );
